...
function updateText() {
    ...
    $.ajax({
        ...
        //     Authorization: getCookie('access_token')
        // },
        url: "https://api.bbichul.site/api/calendars/memo",
        contentType: "application/json",
...
function clickedDayGetMemo(obj) {
    ...
    $.ajax({
        ...
        //     Authorization: getCookie('access_token')
        // },
        url: `https://api.bbichul.site/api/calendars/memo?dateData=${btn_year_month_day}&calendarType=${selected_cal_now}`,
...
function addCalender() {
    ...
    $.ajax({
        ...
        //     Authorization: getCookie('access_token')
        // },
        url: "https://api.bbichul.site/api/calendars/option",
        contentType: "application/json",
        data: JSON.stringify(doc),
        success: function (response) {
            alert(response)
...
function getMemo() {
    ...
    $.ajax({
        ...
        //     Authorization: getCookie('access_token')
        // },
        url: `https://api.bbichul.site/api/calendars/option?calendarType=${selected_cal_now}`,
